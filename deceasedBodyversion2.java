...
public class deceasedBody {
  ...
  // --Version 2.0 of forensic calculator--
//Calculates Algor Mortis. If bodyTemp is -1.0, it accepts a range to calculate the average.
 if(this.bodyTemp != -1.0){
return (37.0-this.bodyTemp)/1.5;
} // Handling missing data via user-provided range
double averageTime= (minTemp + maxTemp)/2.0;
return(37.0-averageTemp)/1.5
  }
